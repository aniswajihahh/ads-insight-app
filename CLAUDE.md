...
An AI-powered data insight tool where users upload CSV/Excel files and instantly receive plain-English summaries, key trends, and interactive Q&A — no manual analysis required.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "252189860+aniswajihahh@users.noreply.github.com"
  git config user.name "aniswajihahh"
  ```
